...
const SCHEMA = [
  ...
  { key: 'threathunt.anthropicKey', type: 'string', default: '',
    ...
    description: 'Anthropic API key. Encrypted at rest (AES-256-GCM).' },
  { key: 'threathunt.openaiKey', type: 'string', default: '',
    category: 'threathunt', sensitivity: 'private',
    legacyKey: 'hunt_openaiKey',
    description: 'OpenAI API key. Encrypted at rest (AES-256-GCM).' },
  { key: 'threathunt.geminiKey', type: 'string', default: '',
    category: 'threathunt', sensitivity: 'private',
    legacyKey: 'hunt_geminiKey',
    description: 'Google Gemini API key. Encrypted at rest (AES-256-GCM).' },
  { key: 'threathunt.anthropicModel', type: 'string', default: 'claude-opus-4-8',
    category: 'threathunt',
    description: 'Anthropic model ID for Threat Hunt (e.g. claude-opus-4-8, claude-opus-4-7)' },
